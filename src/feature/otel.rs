...
use opentelemetry_semantic_conventions::resource::{
    DEPLOYMENT_ENVIRONMENT, HOST_ARCH, OS_TYPE, SERVICE_NAME, SERVICE_NAMESPACE, SERVICE_VERSION,
...
pub fn init_otel(client: Client, logs_endpoint: Url) -> Fallible<OtelGuards> {
    let logger_provider = create_logger_provider(create_resource(), client, logs_endpoint)?;
